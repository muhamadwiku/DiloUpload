...
class ModalAdd extends Component {
  ...
  simpanData = (event) => {
    ...
    fetch('http://kampustelkom.herokuapp.com/api/news', {
      method : 'POST',
      body : JSON.stringify({
        namaPromo: this.state.namaPromo,
        gambarPromo: this.state.gambarPromo,
        deskripsiPromo: this.state.deskripsiPromo,
        statusPromo: this.state.statusPromo,
  ...
  componentDidMount(){
    fetch(`http://kampustelkom.herokuapp.com/api/news/${this.props.id}`)
        ...
        .then(res => this.setState({
          namaPromo: res.namaPromo,
          gambarPromo: res.gambarPromo,
          deskripsiPromo: res.deskripsiPromo,
          statusPromo: res.statusPromo,
